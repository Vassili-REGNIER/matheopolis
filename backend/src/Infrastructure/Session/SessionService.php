...
final class SessionService implements SessionInterface
{
    ...
    public function begin(): void
    {
        ...
        $sameSite = strtoupper($this->config->getString('SESSION_COOKIE_SAMESITE', 'Strict'));
        if (!\in_array($sameSite, ['LAX', 'STRICT', 'NONE'], true)) {
            $sameSite = 'STRICT';
        }
        $this->cookieParams['samesite'] = ucfirst(strtolower($sameSite));
    ...
    private function expireInactiveSession(): void
    {
        ...
        $lastActivityAt = $this->get(self::LAST_ACTIVITY_KEY);
