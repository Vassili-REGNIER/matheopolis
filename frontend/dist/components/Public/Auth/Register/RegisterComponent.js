...
export class RegisterComponent extends BaseComponent {
    ...
    bindEvents() {
        this.queryAll("[data-role]").forEach((button) => {
        ...
        const form = this.query(".register-form");
        if (form !== null) {
        ...
        this.queryAll("[data-action]").forEach((button) => {
            this.listen(button, "click", () => {
    ...
    updateRoleFields() {
        ...
        const emailField = this.query('[data-field="email"]');
        const classCodeField = this.query('[data-field="classCode"]');
        const emailInput = this.query('input[name="email"]');
        const classInput = this.query('input[name="classCode"]');
        const note = this.query(".role-note");
    ...
    async submit(form) {
        const message = this.query(".form-message");
        const submit = this.query(".submit-button");
