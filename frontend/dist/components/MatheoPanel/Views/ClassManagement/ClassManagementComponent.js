...
export class ClassManagementComponent extends BaseComponent {
    ...
    bindEvents() {
        const form = this.query(".class-form");
        if (form !== null) {
        ...
        this.queryAll("[data-class-id]").forEach((button) => {
        ...
        const back = this.query(".back-classes");
        if (back !== null) {
