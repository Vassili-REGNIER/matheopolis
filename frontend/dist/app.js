...
export class App {
    ...
    setupRoutes(router) {
        ...
        router.addRoute("/game/:riddleId", (params) => new GameContainerComponent(this.mainContainer(), router, this.services, parseIntegerParam(params.riddleId, 2)), { protectedRoute: true });
