...
- `RiddleBlockComponent`: the UI shell of a riddle. Its sole role is to instantiate the mini-game matching
  the step, give it an HTML container, and listen for its resolution.
