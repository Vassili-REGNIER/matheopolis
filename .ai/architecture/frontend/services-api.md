...
- `ChapterService`: narrative chapters (`listChapters`, `getChapter`), chapter progression, riddle start, and
  per-question riddle answer submission through `/api/riddles/{id}/responses`.
